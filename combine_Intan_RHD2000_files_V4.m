function combine_Intan_RHD2000_files_V4

% combine_Intan_RHD2000_files
% Edited from read_Intan_RHD2000_file.m by Stewart Holloway
%
% Version 4 20/Oct/16
% Hanlin added automated combination of all rhd files in the current folder
% assuming that they are in the order according to the timestamp in their
% file name. 
