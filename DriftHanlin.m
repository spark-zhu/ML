function DriftHanlin(angle, cyclespersecond, f, drawmask, gratingsize)
...
vbl=Screen('Flip', w);
    ...
    while(vbl < vblendtime)
        ...
        % Draw grating texture, rotated by "angle":
        Screen('DrawTexture', w, gratingtex, srcRect, dstRect, angle+90);

        if drawmask==1
            % Draw gaussian mask over grating:
            Screen('DrawTexture', w, masktex, [0 0 visiblesize visiblesize], dstRect, angle+90);
        end;
